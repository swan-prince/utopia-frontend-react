...
// Get Unique Ratings from Json Data
export const getRatings = (products) => {
    var uniqueRatings = [1, 2, 3, 4, 5];
...
export const getVisibleproducts = (data, { brand, color, value, sortBy, rating }) => {
    return data.products.filter(product => {
        ...
        return brandMatch && colorMatch && startPriceMatch && endPriceMatch && ratingMatch;
